...
class REPL extends teddy.Component {
  constructor(props) {
    super(props);
  }
  onEditorChange(editors, frame) {
    ...
    setTimeout(() => {
      try {
        let code = transform(values.js, babelOpts).code;
        new Function(code)();
      } catch (e) {
  ...
  componentDidMount(dom) {
    document.addEventListener("DOMContentLoaded", () => {
      ...
      window.TeddyTags = teddy.TeddyTags;
      let editors = {
...
teddy.render(<REPL />, document.querySelector("#root"));
